...
export default function NewEvaluationPage() {
  ...
  const handleCreateManual = () => {
    // Clear any previous template and set a new default one
    setTemplate(createDefaultTemplate(tFormBuilder, tQuestionTypes));
    // Use a timestamp or a specific keyword to indicate a new, unsaved evaluation
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Clear any previous template and set the one generated by the AI
