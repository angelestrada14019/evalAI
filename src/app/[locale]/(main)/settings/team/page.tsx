...
export default async function TeamSettingsPage() {
  ...
  const tt = await getTranslations('TeamSettingsPage');
  return (
            ...
            <CardContent>
              <div className="rounded-lg border">
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead>{tt('tableMember')}</TableHead>
                            <TableHead>{tt('tableRole')}</TableHead>
                            <TableHead className="text-right">{tt('tableActions')}</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                            ...
                            <TableRow key={member.email}>
                                ...
                                <TableCell className="text-right">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuItem>{tt('editRoleAction')}</DropdownMenuItem>
                                        <DropdownMenuItem className="text-destructive">{tt('removeAction')}</DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
                                </TableCell>
                            </TableRow>
